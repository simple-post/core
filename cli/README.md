...
Post to X, Telegram, YouTube, Instagram, Facebook, TikTok, Bluesky, Threads, LinkedIn, Pinterest, and Lemmy from your terminal.
...
- **Lemmy** — connect directly to an instance with username, password, and a default community ID.
