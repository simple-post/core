...
| Telegram  | Image dimension sum/ratio; MP4 video; HTML tag/entity validity and decoded length; bot/channel/group media permissions                                                                                                           | Markdown modes explicitly return an unverified-formatting warning; inaccessible reply targets and private-chat blocks may be provider-side                                                                |
