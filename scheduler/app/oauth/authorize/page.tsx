...
export default function OAuthAuthorizePage() {
  return (
    <AuthorizePage
      config={{
        title: "Authorize App",
        description: "An application is requesting access to your SimplePost account.",
        invalidMessage: "This authorization link is invalid or has expired. Please try connecting again from your AI assistant.",
        ...
        validateParams: (params) =>
          !!(params.get("client_id") && params.get("redirect_uri") && params.get("state") && params.get("code_challenge")),
        authorize: (params) =>
