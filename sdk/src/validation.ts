...
import { FARCASTER_VALIDATION_RULES, validateFarcasterContent } from "./publishers/farcaster/validation";
...
export const PLATFORM_VALIDATORS: Record<Platform, PlatformValidator> = {
  ...
  farcaster: { rules: FARCASTER_VALIDATION_RULES, validate: validateFarcasterContent },
};
...
export { FARCASTER_VALIDATION_RULES, validateFarcasterContent } from "./publishers/farcaster/validation";
