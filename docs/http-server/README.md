...
| `platform`          | Yes      | One of `x`, `telegram`, `facebook`, `instagram`, `youtube`, `tiktok`, `bluesky`, `threads`, `linkedin`, `pinterest`, `forem`, `farcaster`. The legacy alias `twitter` maps to `x`. |
