...
Post to X, Telegram, YouTube, Instagram, Facebook, TikTok, Bluesky, Threads, LinkedIn, Pinterest, and Discord from your terminal.
...
- **Discord** — no OAuth app; connect with a channel webhook: `simplepost account add discord --webhook-url "$DISCORD_WEBHOOK_URL"`.
